...
public class shirt7 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(shirt7.this, OrderMain.class);
        ...
        nextLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt7.this, shirt6.class);
                startActivity(intent);
            }
        });
        ...
        nextRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt7.this, shirt8.class);
                startActivity(intent);
            }
        });
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity == 0){
                    ...
                    Toast.makeText(shirt7.this,"Items with a quantity less than one cannot be added to the cart.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(shirt7.this, "Please add your size", Toast.LENGTH_SHORT).show();
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(shirt7.this, "Quantity is already 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int shirtPrice = basePrice * quantity;
...
//        Button orderMore = findViewById(R.id.OrderMore);
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt7.this, summaryActivity.class);
                startActivity(intent);
            }
        });
