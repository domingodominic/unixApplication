...
public class shirt4 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        description.setText("Get the perfect blend of style and comfort with our Gucci t-shirt.");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(shirt4.this, OrderMain.class);
        ...
        nextLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt4.this, shirt3.class);
                startActivity(intent);
            }
        });
        ...
        nextRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt4.this, shirt5.class);
                startActivity(intent);
            }
        });
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity == 0){
                    ...
                    Toast.makeText(shirt4.this,"Items with a quantity less than one cannot be added to the cart.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(shirt4.this, "Please add your size", Toast.LENGTH_SHORT).show();
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(shirt4.this, "Quantity is already 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int shirtPrice = basePrice * quantity;
...
//        Button orderMore = findViewById(R.id.OrderMore);
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt4.this, summaryActivity.class);
                startActivity(intent);
            }
        });
