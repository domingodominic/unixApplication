...
public class infoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        description.setText("White cotton that is stylish and convenient Gucci t-shirt");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(infoActivity.this, OrderMain.class);
        ...
        nextLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(infoActivity.this, "No more shirt", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               Intent intent = new Intent(infoActivity.this, shirt1.class);
               startActivity(intent);
            }
        });
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity == 0){
                    ...
                    Toast.makeText(infoActivity.this,"Items with a quantity less than one cannot be added to the cart.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(infoActivity.this, "Please add your size", Toast.LENGTH_SHORT).show();
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(infoActivity.this, "Quantity is already 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int shirtPrice = basePrice * quantity;
    ...
    private boolean SaveCart() {
        ...
        if (addSmall.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_SMALL, "Dri Fit Upgrade: YES: YES");
        } else {
