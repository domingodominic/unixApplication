...
public class shirt5 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.slider6);
        shirtName.setText("H&M");
        description.setText("Upgrade your casual look with our stylish H&M t-shirt.");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(shirt5.this, OrderMain.class);
        ...
        nextLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt5.this, shirt4.class);
                startActivity(intent);
            }
        });
        ...
        nextRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt5.this, shirt6.class);
                startActivity(intent);
            }
        });
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity == 0){
                    ...
                    Toast.makeText(shirt5.this,"Items with a quantity less than one cannot be added to the cart.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(shirt5.this, "Please add your size", Toast.LENGTH_SHORT).show();
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(shirt5.this, "Quantity is already 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int shirtPrice = basePrice * quantity;
...
//        Button orderMore = findViewById(R.id.OrderMore);
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt5.this, summaryActivity.class);
                startActivity(intent);
            }
        });
