...
public class shirt1 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        description.setText("Stay cool and look great in our breathable Lacoste t-shirt.");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(shirt1.this, OrderMain.class);
        ...
        nextLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt1.this, infoActivity.class);
                startActivity(intent);
            }
        });
        ...
        nextRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt1.this, shirt2.class);
                startActivity(intent);
            }
        });
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    ...
                    Toast.makeText(shirt1.this, "Items with a quantity less than one cannot be added to the cart.", Toast.LENGTH_SHORT).show();

                } else if (smallBtn.isChecked() || largeBtn.isChecked() || mediumBtn.isChecked()) {
                    SaveCart();

                } else {
                    Toast.makeText(shirt1.this, "Please add your size", Toast.LENGTH_SHORT).show();
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(shirt1.this, "Quantity is already 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int shirtPrice = basePrice * quantity;
...
//        Button orderMore = findViewById(R.id.OrderMore);
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shirt1.this, summaryActivity.class);
                startActivity(intent);
            }
        });
